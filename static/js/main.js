...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(5), __webpack_require__(28), __webpack_require__(6), __webpack_require__(2), __webpack_require__(0), __webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, ProductModel_1, InterfaceRoom_1, nb_NO, kv, ko, $) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var titleCase = __webpack_require__(7);
    ...
    var TSAppViewModel = (function () {
        function TSAppViewModel() {
            ...
            this.anleggs_adresse2 = ko.observable().extend({
                required: false,
                minLength: 3,
                maxLength: 50
            });
            ...
            this.suggestRoom = function () {
                var listOfRooms = [];
                InterfaceRoom_1.Rooms.forEach(function (room, index) {
                    listOfRooms.push({
                        name: room.name,
                        id: index
                    });
            ...
            this.roomSuggestionOnSelect = function (value, room) {
                var roomObject = InterfaceRoom_1.Rooms[room.id];
                _this.outside((roomObject.outside));
            };
            this.suggestionOnSelect = function (value, address) {
                value(titleCase(address.street_name));
                _this.anleggs_postnummer(address.post_code);
                _this.anleggs_poststed(address.post_area.toUpperCase());
            };
            ...
            this.autocompleteAddress = ko.computed(function () {
                var url = '/address/?q=%QUERY';
                if (_this.anleggs_postnummer()) {
                    url += '&p=' + _this.anleggs_postnummer();
                }
                return url;
        ...
        function TSProductModel(parentModel) {
            ...
            this.filtered_products = ko.computed(function () {
                ...
                return ko.utils.arrayFilter(_this.filtered_products_no_mainSpec(), function (prod) {
                    ...
                    var effect = parentModel.effect();
                    if (effect) {
                        var diffA = Math.abs(effect - a.effect);
                        var diffB = Math.abs(effect - b.effect);
                        return diffA - diffB;
                    }
                    else {
                        return (a.effect) - (b.effect);
...
var noCase = __webpack_require__(8)
var upperCase = __webpack_require__(13)
...
var NON_WORD_REGEXP = __webpack_require__(10)
...
var ko = __webpack_require__(0);
var stringTemplateEngine = __webpack_require__(26);
