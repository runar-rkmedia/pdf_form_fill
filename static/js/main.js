...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(2), __webpack_require__(14)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, Common_1, HeatingCable_1) {
    ...
    var Room = (function (_super) {
        ...
        function Room(root, parent, room) {
            ...
            _this.max_temp_limited_by_planning = ko.observable();
            _this.max_temp_limited_by_installation = ko.observable();
            ...
            _this.modified = ko.computed(function () {
                ...
                if (_this.name() != _this.last_sent_data().room_name ||
                    _this.outside() != _this.last_sent_data().outside ||
                    _this.area() != _this.last_sent_data().area ||
                    _this.heated_area() != _this.last_sent_data().heated_area) {
                    return true;
                }
                return false;
            });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_bootstrap_js_tab__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__bootstrap_less__ = __webpack_require__(40);
