...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports) {
    ...
    var Base = (function () {
        function Base() {
            var _this = this;
            this.modified = ko.computed(function () { return false; });
            this.init = function () {
                ...
                _this.modified = ko.computed(function () {
                    var difference = _this.differences();
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(2), __webpack_require__(14)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, Common_1, HeatingCable_1) {
    ...
    var Room = (function (_super) {
        ...
        function Room(root, parent, room) {
            ...
            _this.earthed_cable_screen = ko.observable();
            _this.earthed_chicken_wire = ko.observable();
            _this.earthed_other = ko.observable();
            _this.max_temp_limited_by_planning = ko.observable(true);
            _this.max_temp_limited_by_installation = ko.observable(true);
            _this.max_temp_limited_by_other = ko.observable();
            _this.control_system_floor_sensor = ko.observable(true);
            _this.control_system_room_sensor = ko.observable(true);
            _this.control_system_designation = ko.observable();
            _this.control_system_other = ko.observable();
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(2), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, Common_1, ProductModel_1) {
    ...
    var InputReadOnlyToggle = (function () {
        function InputReadOnlyToggle(calculateFunction) {
            var _this = this;
            this.override = ko.observable(false);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__bootstrap_less__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__bootstrap_less___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__bootstrap_less__);
