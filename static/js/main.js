...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports) {
    ...
    var Base = (function () {
        ...
        Base.prototype.save = function () {
            for (var _i = 0, _a = this.modification_tracking_list(); _i < _a.length; _i++) {
                var observable = _a[_i];
                if (observable) {
                    observable.save();
                }
            }
        };
        Base.prototype.modification_check = function (list) {
            for (var _i = 0, list_1 = list; _i < list_1.length; _i++) {
                var observable = list_1[_i];
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(0)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, ko) {
    ...
    var myArrayFilter = function (list_to_filter) {
    ...
    var ProductFilter = (function () {
        function ProductFilter(target, product_model) {
            ...
            // queens road: 850m
            // princes road: 750m
            this.sortDist = function (list, setPoint, key) {
                if (key === void 0) { key = 'effect'; }
                return list.sort(function (a, b) {
                    if (setPoint) {
                        var diffA = Math.abs(setPoint - a[key]);
                        var diffB = Math.abs(setPoint - b[key]);
                        return diffA - diffB;
                    }
                    else {
                        return (a[key]) - (b[key]);
            ...
            this.by_id = function (id) {
                var f = _this.product_model.flat_products();
                return f.find(function (myObj) {
                    return myObj.id === Number(id);
                });
            };
            this.target = target;
...
module.exports = "static/static/f4769f9bdb7466be65088239c12046d1.eot";

/***/ }),
/* 8 */
/***/ (function(module, exports, __webpack_require__) {

var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(1), __webpack_require__(9), __webpack_require__(33), __webpack_require__(38)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, $, AppViewModel_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(12), __webpack_require__(2), __webpack_require__(0)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, Rooms_1, Common_1, ko) {
    ...
    var Customer = (function (_super) {
        ...
        function Customer(parent, id, root) {
            ...
            _this.address1.extend({ required: true, minLength: 2, maxLength: 200 });
            _this.address2.extend({ required: false, maxLength: 200 });
            _this.post_area.extend({ required: true, minLength: 2, maxLength: 100 });
            _this.post_code.extend({ required: true, number: true, min: 0, max: 9999 });
        ...
        Customer.prototype.set = function (result) {
            ...
            if (result.rooms) {
                var new_rooms = result.rooms.map(function (x) {
                    return new Rooms_1.Room(_this.root, _this.rooms(), x);
                });
                this.rooms(new Rooms_1.Rooms(this.root, this, new_rooms));
            }
            this.save();
        };
        return Customer;
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(2), __webpack_require__(14)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, Common_1, HeatingCable_1) {
    ...
    var Rooms = (function (_super) {
        ...
        function Rooms(root, parent, list_of_rooms) {
            ...
            var _this = _super.call(this, list_of_rooms) || this;
            _this.add = function () {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(2), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, Common_1, ProductModel_1) {
    ...
    var InputReadOnlyToggle = (function () {
        function InputReadOnlyToggle(calculateFunction, modification_observable) {
            ...
            ko.computed(function () {
                if (!_this.override()) {
                    _this.user_input(_this.calculated().toFixed(1));
                }
            });
        }
        return InputReadOnlyToggle;
    }());
    var HeatingCable = (function (_super) {
        ...
        function HeatingCable(product_model, parent, heating_cable_) {
            ...
            _this.modifications_other = ko.computed(function () {
            ...
            _this.serialize = ko.computed(function () {
                var obj = {
                    ...
                    specs: {
                        ...
                        cc: _this.cc().serialize(),
                        area_output: _this.area_output().serialize()
                    },
                };
                return obj;
            });
            _this.suggested_effect = ko.computed(function () {
                var this_effect = 0;
                if (_this.product()) {
                    this_effect = _this.product().effect;
                }
                return _this.parent.parent.bestFitEffect() - (_this.parent.parent.room_effect() - this_effect);
            });
    ...
    var HeatingCables = (function (_super) {
        ...
        function HeatingCables(root, parent, heating_cables) {
            ...
            if (heating_cables_objects) {
                ...
                heating_cables_objects = heating_cables.map(function (x) {
                    return new HeatingCable(self_1.root.Products(), self_1, x);
                });
            }
...
var noCase = __webpack_require__(16)
...
ko.bindingHandlers.typeahead = {
	update: function (element, valueAccessor, allBindings) {
		...
		var localSuggestions = allBindings.get("localSuggestions");
		...
		var blooghoundarguments = {
			datumTokenizer: function (token) {
				if (localSuggestions) {
					token = token[displayedProperty]
				}
		...
		if (localSuggestions) {
			blooghoundarguments.local = url;
		} else {
			blooghoundarguments.remote =	remoteData;
		}

		var suggestions = new Bloodhound(blooghoundarguments);
		...
		.on("typeahead:selected typeahead:autocompleted", function (e, suggestion) {
			if (onSelect) {
				onSelect(value, suggestion, e, element)
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../css-loader/index.js!../less-loader/dist/cjs.js!./typeahead.less", function() {
			var newContent = require("!!../css-loader/index.js!../less-loader/dist/cjs.js!./typeahead.less");
...
var ko = __webpack_require__(0);
var stringTemplateEngine = __webpack_require__(32);
...
var templates = {},
    _data = {},
    engine = new _knockout2.default.nativeTemplateEngine(); //https://github.com/rniemeyer/SamplePresentation/blob/master/js/stringTemplateEngine.js
...
_knockout2.default.templates = templates;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_bootstrap_js_transition__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_bootstrap_js_button__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_bootstrap_js_collapse__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_bootstrap_js_tab__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_bootstrap_js_tab___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_bootstrap_js_tab__);
...
module.exports = "static/static/e18bbf611f2a2e43afc071aa2f4e1512.ttf";
