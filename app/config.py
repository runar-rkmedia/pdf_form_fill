...
class BaseConfig(object):
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get(
        'DATABASE_URL', os.environ.get('postgres:///varmekabler'))
    SQLALCHEMY_BINDS = {
        'products': os.environ.get(
            'PRODUCT_DATABASE_URL', os.environ.get('postgres:///vk_products')),
    }
...
class TestingConfig(BaseConfig):
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('postgres:///test_varmeka)bler'
    SQLALCHEMY_BINDS = {
        'products': os.environ.get('postgres:///vk_products')
    }
    SECRET_KEY = 'test'
    DEBUG = False
    TESTING = True
